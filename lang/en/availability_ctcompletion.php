...
$string['cachedef_ct_previous_cache'] = 'Previous activity dependency information';
$string['description'] = 'Require students to complete (or not complete) another activity.';
$string['ctcompletion:completeforgroup'] = 'Complete for group';
...
$string['option_ctcompletion'] = 'must be completed by CT in same group';
...
$string['pluginname'] = 'Restriction by activity CT completion';
...
$string['requires_ctcomplete'] = 'The activity <strong>{$a}</strong> is marked complete by CT';
$string['requires_not_ctcomplete'] = 'The activity <strong>{$a}</strong> is not marked complete by CT';
...
$string['title'] = 'Activity CT completion';
$string['privacy:metadata'] = 'The Restriction by activity CT completion plugin does not store any personal data.';
